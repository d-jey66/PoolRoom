          ...
          <View className="w-full h-full border flex flex-col px-5 py-12 gap-5 items-center justify-center">    
            ...
            <View className='border border-gray-800 w-full h-auto rounded-2xl py-6 px-6 gap-5'>
              <View className='w-full flex flex-col items-center justify-center gap-5'>
                <Text className='font-bold text-4xl text-purple-400'>Login</Text>
              ...
              <View className='flex flex-col gap-5'>
                ...
                <View className='flex flex-row gap-2 items-center justify-center'>
                  <Text className='font-bold text-gray-500'>Don't Have An Account?</Text>
                  <TouchableOpacity onPress={handleNavigation}><Text className='font-bold text-blue-800'>Signup</Text></TouchableOpacity>
                </View>
              </View>
            </View>
          </View>
